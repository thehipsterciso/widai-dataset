...
**URL:** https://www.onetonline.org/help/license  
...
> "Contains public sector information licensed under the Open Government Licence v3.0. The DDaT Professional Capability Framework is published by the UK Government Digital Service and is available under the Open Government Licence v3.0."

**License:** Open Government Licence 3.0  
**Publisher:** UK Government Digital Service  
**URL:** https://www.gov.uk/guidance/data-profession-capability-framework  
**Commercial Use:** Permitted with attribution
...
This product includes material from dbt Labs distributed under the Apache License 2.0.
...
**Publisher:** dbt Labs  
**URL:** https://www.getdbt.com/analytics-engineering/  
**Commercial Use:** Permitted with license notice
...
- **NIST AI RMF** (AI Risk Management Framework) — AI governance and risk assessment model
- **DCWF** (DoD Cyber Workforce Framework) — Department of Defense cybersecurity workforce standards
- **HIPAA** (Health Insurance Portability and Accountability Act) — Healthcare sector data protection regulations
- **Evidence Act** — Federal data governance and modernization requirements
- **FDA** (Food and Drug Administration) — Regulatory framework for AI-enabled medical devices
- **FED SR 11-7** (Federal Reserve Guidance) — Banking sector AI and automation guidance
- **OCC** (Office of the Comptroller of the Currency) — Banking sector regulation and oversight
...
- **Singapore MAIG** (Model AI Governance Framework) — Singapore government AI governance framework
...
The following frameworks are included as open architectural patterns or educational resources:

- **Data Mesh** — Open architectural pattern for distributed data systems (Chris Richardson, open community)
- **80000 Hours** — Career guidance and research framework (non-profit organization, educational content)
...
## Framework License Summary

| Framework | Publisher | License | Commercial Use | Attribution Required |
|-----------|-----------|---------|-----------------|----------------------|
| **O*NET** | U.S. Department of Labor (USDOL/ETA) | CC BY 4.0 | ✓ Yes | ✓ Required |
| **BLS-SOC** | U.S. Bureau of Labor Statistics | Public Domain | ✓ Yes | Recommended |
| **NIST NICE** | National Institute of Standards and Technology | Public Domain | ✓ Yes | Recommended |
| **NIST AI RMF** | National Institute of Standards and Technology | Public Domain | ✓ Yes | Recommended |
| **DCWF** | U.S. Department of Defense / NIST | Public Domain | ✓ Yes | Recommended |
| **DDaT** | UK Government Digital Service | OGL 3.0 | ✓ Yes | ✓ Required |
| **EU AI Act** | European Union Commission/Parliament | Public Domain (Legislation) | ✓ Yes | Recommended |
| **GDPR** | European Union | Public Domain (Legislation) | ✓ Yes | Recommended |
| **Evidence Act** | U.S. Congress | Public Domain (Legislation) | ✓ Yes | Recommended |
| **Executive Order** | U.S. Executive Branch | Public Domain | ✓ Yes | Recommended |
| **FDA** | U.S. Food and Drug Administration | CC0 1.0 / Public Domain | ✓ Yes | Not Required |
| **FED SR 11-7** | U.S. Federal Reserve | Public Domain | ✓ Yes | Recommended |
| **HIPAA** | U.S. Department of Health & Human Services | Public Domain (Legislation) | ✓ Yes | Recommended |
| **OCC** | Office of the Comptroller of the Currency (U.S. Treasury) | Public Domain | ✓ Yes | Recommended |
| **dbt Labs** | dbt Labs | Apache License 2.0 | ✓ Yes | ✓ Required (License Notice) |
...
- **ISO Standards:** ISO-23894, ISO-27001, ISO-27701, ISO-38505, ISO-42001, ISO-5338, ISO-8000 (copyrighted standards; purchase/license required)
- **Proprietary Platform Frameworks:** AWS, Microsoft, LinkedIn, Coursera, and similar (platform-specific terms and conditions apply)
- **Non-Commercial Restricted:** WEF (CC BY-NC-ND prohibits commercial derivatives), HBR, DAMA-DMBOK (restricted licensing), and others
...
> - NIST NICE and NIST AI RMF (National Institute of Standards and Technology) — Public Domain
> - DDaT (UK Government Digital Service) — Open Government Licence 3.0
> - DoD Cyber Workforce Framework (U.S. Department of Defense) — Public Domain
> - EU AI Act and GDPR (European Union) — Public Domain Legislation
> - dbt Labs (Analytics Engineering) — Apache License 2.0
> - Additional public domain frameworks and regulatory guidance from U.S. federal agencies
>
...
5. **Audited for Accuracy** — Verified against `R05-license-audit.md` before each major release

### Version History

| Version | Date | Changes | Reviewed By |
|---------|------|---------|-------------|
| 1.0 | 2026-03-26 | Initial creation; 19 GREEN frameworks documented | [Legal Review] |
